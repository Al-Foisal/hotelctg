            ...
            <div class="row">
                <div class="col">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Product Categroy</li>
                    </ol>
                </div><!--end col-->
            </div><!--end row-->
...
<div class="row">
    ...
    <div class="card">
        <div class="card-header row">
            ...
            <div class="col-md-6">
                <form action="{{route('is.productCategory.index')}}" class="me-1">
                    <div class="input-group mb-3 table-search-box">
                        ...
                        <a class="btn btn-danger" href="{{route('is.productCategory.index')}}" title="Reset">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-start">
                                    ...
                                    <form action="{{route('is.productCategory.delete',$item->id)}}" method="post">
                                        @csrf
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{route('is.productCategory.update',$item->id)}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-md-12 mb-3">
                                                            <label class="form-label" for="exampleInputEmail1">Product Category</label>
                                                            <input type="text" class="form-control" placeholder="Enter Product Category" name="name" required value="{{$item->name??''}}">
                                                        </div>
...
<div class="modal fade modal-fullscreen-down" id="createNewModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('is.productCategory.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label class="form-label" for="exampleInputEmail1">Product Category*</label>
                            <input type="text" class="form-control" placeholder="Enter Product Category" name="name" required>
                        </div>
