...
@section('title','Resturant item category')
@section('content')
<!-- Page-Title -->
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="row">
                <div class="col">
                    <h4 class="page-title text-capitalize fw-semibold">Resturant item category</h4>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="{{route('dashboard')}}">{{config('app.name')}}</a>
                        </li>
                        <li class="breadcrumb-item">Resturant</li>
                        <li class="breadcrumb-item active">Menu item category</li>
                    </ol>
                </div><!--end col-->
            </div><!--end row-->
...
<div class="row">
    ...
    <div class="card">
        <div class="card-header row">
            ...
            <div class="col-md-6">
                <form action="{{route('resturant.menuItemCategory.index')}}" class="me-1">
                    <div class="input-group mb-3 table-search-box">
                        ...
                        <a class="btn btn-danger" href="{{route('resturant.menuItemCategory.index')}}" title="Reset">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-start">
                                    ...
                                    <form action="{{route('resturant.menuItemCategory.delete',$item->id)}}" method="post">
                                        @csrf
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{route('resturant.menuItemCategory.update',$item->id)}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-md-12 mb-3">
                                                            <label class="form-label" for="exampleInputEmail1">Category</label>
                                                            <input type="text" class="form-control" placeholder="Enter Category" name="name" required value="{{$item->name??''}}">
                                                        </div>
...
<div class="modal fade modal-fullscreen-down" id="createNewModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('resturant.menuItemCategory.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label class="form-label" for="exampleInputEmail1">Category*</label>
